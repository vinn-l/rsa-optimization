...
The src directory contains the .c files.\
The asm directory contains the .s files, these .s files are generated by the compiler with -O1 flag, and were not further modified.
