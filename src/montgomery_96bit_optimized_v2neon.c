...
// Optimization: Attempt Neon Operation for add_uint96
...
uint96_t add_uint96(uint96_t x, uint96_t y)
{
    ...
    uint96_t return_result = {high, mid, low};
...
uint96_t modular_exponentiation_mont_32x3(uint96_t b, uint96_t e, uint96_t m, int numBits, uint96_t r2_mod)
{
    uint96_t ONE = {0,0,1};
